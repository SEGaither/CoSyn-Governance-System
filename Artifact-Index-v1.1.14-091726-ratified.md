...
**Artifact:** `Artifact-Index-v1.1.14-091726-ratified.md`  
**Version:** 1.1.14  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-17  
**Supersedes:** `Artifact-Index-v1.1.13-091726-ratified.md`  
**Scope:** Current known CoSyn v18 / Tier artifact set established by v1.1.13 plus ratified ATTAS canon v1.1.1 and its task-routing state.  
...
| `attas-canon-v1.1.1.md` | `CoSyn-18-core-trinity\tier 3\attas\attas-canon-v1.1.1.md` | 1.1.1 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Story Canonical Record — The Roatan Amulet v1` | Unknown | Unknown | Authoritative ATTAS Book 1 and continuing-series story canon; canon protections, unresolved canon, and approved Veyra/Ligos state | Repository path/content/status verified 2026-09-17; exact SHA-256 not independently established | KEEP ACTIVE |
| `Artifact-Index-v1.1.14-091726-ratified.md` | repository root when installed | 1.1.14 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Artifact-Index-v1.1.13-091726-ratified.md` | Unknown | self-hash assigned after final byte generation | Canonical artifact index, cleanup basis, and task-routing reference | Updated and ratified by explicit User instruction on 2026-09-17 to index the new ATTAS canon repository artifact | KEEP ACTIVE |
...
| `attas-canon-v1.1.1.md` | `CONDITIONAL` | ATTAS story-canon, manuscript-development, continuity, character/worldbuilding, canon-protection, or canon-reconciliation work | Do not load for unrelated writing projects or non-ATTAS tasks |
| `Artifact-Index-v1.1.14-091726-ratified.md` | `BOUND-BASELINE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
...
*Document ID: Artifact-Index-v1.1.14-091726-ratified — RATIFIED / ACTIVE / CURRENT.*