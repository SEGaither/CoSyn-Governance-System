...
**Artifact:** `Artifact-Index-v1.1.18-092126-ratified.md`  
**Version:** 1.1.18  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-21  
**Supersedes:** `Artifact-Index-v1.1.17-092126-ratified.md`  
**Scope:** Current known CoSyn v18 / Tier artifact set established by ratified v1.1.17 plus explicit project-cache policy for indexed active artifacts. The unrelated local v1.1.16 index candidate remains unratified and is not promoted or incorporated by this revision.  
...
| `Artifact-Index-v1.1.18-092126-ratified.md` | LOCAL RENDERED ARTIFACT — repository installation not performed | 1.1.18 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Artifact-Index-v1.1.17-092126-ratified.md` | Unknown | self-hash assigned after final byte generation | Canonical artifact index, cleanup basis, task-routing reference, and project-cache policy reference | Updated and ratified by explicit User instruction on 2026-09-21 to add deterministic project-cache policy to indexed active artifacts; GitHub repository not modified | KEEP ACTIVE LOCALLY; repository install only by separate authorization |
...
| `Artifact-Index-v1.1.18-092126-ratified.md` | `BOUND-BASELINE` | `PROJECT-CACHE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
