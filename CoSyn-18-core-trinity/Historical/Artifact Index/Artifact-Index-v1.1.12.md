...
**Artifact:** `Artifact-Index-v1.1.12.md`  
**Version:** 1.1.12  
**Status:** CANDIDATE / UPDATED — AWAITING USER RATIFICATION  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-17  
**Proposed supersession:** `Artifact-Index-v1.1.11.md` upon User ratification  
**Scope:** Current known CoSyn v18 / Tier artifact set established by v1.1.11 plus reconciliation of ratified GPT Compute Conservation v1.2.0 and its routing/supersession state.  
**Completeness:** Candidate operational successor with task-routing support. Unresolved source-level dependency, lineage, and ambiguous-authority items remain explicitly listed in Section 11.
...
| `Zero-v3.0.0-090826-ratified.md` | `CoSyn-18-core-trinity\Tier 2 Personal\Zero-v3.0.0-090826-ratified.md` | 3.0.0 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Zero-v2.2.2-090826-ratified.md` | Unknown | `0E85DBB3973A118D5EE33BABDD2B8905B0AF30726E5C835128025053C7246E88` | Software engineering / LLM programming persona | Canonical content hash established; recon found identical duplicate copies elsewhere | KEEP ACTIVE; remove/archive duplicate copies only |
...
| `Artifact-Index-v1.1.11.md` | repository root when installed | 1.1.11 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Artifact-Index-v1.0.10.md` | Unknown | self-hash assigned after final byte generation | Canonical artifact index, cleanup basis, and task-routing reference | Ratified by explicit User instruction on 2026-09-17; rendered successor artifact | KEEP ACTIVE / INSTALL ONLY BY SEPARATELY AUTHORIZED REPOSITORY MUTATION |
...
| Artifact | Load class | Routing trigger / applies to | Normal exclusion |
|---|---|---|---|
| `cgs-core-v18.0.1-constitution.md` | `BOUND-BASELINE` | Establishing or restoring the CoSyn constitutional baseline | Do not reread per turn after current identity is established |
| `cgs-core-v18.0.2-persona-governor.md` | `BOUND-BASELINE` | Establishing or restoring persona/governance enforcement baseline | Do not reread per turn after current identity is established |
| `cgs-core-v18.0.2-stack-architect.md` | `BOUND-BASELINE` | Establishing or restoring authority/routing architecture baseline; resolving a routing ambiguity not answerable from this index | Do not invoke merely because multiple artifacts exist |
| `Guppi-v1.3.17-091726-ratified.md` | `BOUND-BASELINE` | Normal cross-project assistant identity, interaction behavior, established-state reuse, and task routing | Do not reread per turn after current identity is established |
| `cgs-v18.0.1-tier2-personal-response-instructions-v1.3.md` | `BOUND-BASELINE` | Normal response compactness, usable-path behavior, root-cause closure, and compact per-turn execution | Do not reread per turn after current identity is established |
| `Zero-v3.0.0-090826-ratified.md` | `CONDITIONAL` | Software engineering; LLM/API/agent engineering; scripts; debugging; repository work; Git-adjacent technical execution | Do not load for unrelated writing, general discussion, or nontechnical tasks |
| `cgs-v18.0.1-tier2-general-work-session-management-team-persona-v1.1.1-091726.md` | `CONDITIONAL` | Consequential, stateful, multi-step, multi-file, multi-decision, continuity-sensitive, or session-handoff work | Do not load for ordinary simple turns |
| `git-repository-change-safety-protocol-v1.0.0-082126.md` | `CONDITIONAL` | Git inspection, staging, commit, branch/history manipulation, push/pull/fetch/reset/restore/clean/stash, or other repository-state mutation | Do not load for non-Git filesystem work merely because the files are inside a Git repository |
| `GPT-compute-conservation-v1.2.0-091726.md` | `CONDITIONAL` | ChatGPT execution of an already-developed, approved, accepted, or otherwise established plan or defined execution stage | Do not load for plan creation, ordinary discussion, or work not executing an established plan |
| `cgs-v18.0.1-wbg-general-writing-project-workbook-template-v1.0.1.md` | `CONDITIONAL` | Creating or using the WBG writing-project workbook/template | Do not load for unrelated writing tasks |
| `cgs-v18.0.1-wbg-personal-project-package-creation-workflow-v1.0.1.md` | `CONDITIONAL` | Creating a WBG Personal project package | Do not load for ordinary writing or non-package work |
| `cgs-v18.0.1-wbg-personal-root-profile-v1.3.1.md` | `CONDITIONAL` | WBG Personal work requiring the personal writing root profile | Do not load for non-WBG tasks |
| `cgs-v18.0.1-wbg-personal-readme-wbg-personal-v1.3.2.md` | `ON-REQUEST` | WBG Personal package guidance, package interpretation, or explicit README review | Do not load merely because WBG Personal is involved |
| `cgs-v18.0.1-wbg-personal-validation-report-v1.3.2.md` | `ON-REQUEST` | WBG validation evidence, validation review, or explicit evidence comparison | Do not load for execution tasks that do not require prior validation evidence |
| `cgs-v18.0.1-wbg-personal-provenance-v1.3.2.md` | `ON-REQUEST` | Provenance, history, audit, lineage, or explicit source-trace questions | Do not load for normal task execution |
| `Artifact-Index-v1.1.11.md` | `BOUND-BASELINE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
...
| Software or repository diagnosis without Git mutation | `Zero-v3.0.0-090826-ratified.md`; add Work Session Management only if the task is consequential/stateful |
| Git staging/commit/push or repository-history work | `Zero-v3.0.0-090826-ratified.md` + `git-repository-change-safety-protocol-v1.0.0-082126.md`; add Work Session Management only when materially warranted |
...
## 14. v1.1.12 Candidate Revision Note

`Artifact-Index-v1.1.12.md` is a bounded candidate successor to the ratified `Artifact-Index-v1.1.11.md`.

This revision changes only the index surfaces invalidated by the verified addition of ratified GPT Compute Conservation v1.2.0 to the repository.

Changes in v1.1.12:

- adds `GPT-compute-conservation-v1.2.0-091726.md` as RATIFIED / ACTIVE;
- records its verified repository path and SHA-256;
- records explicit supersession of `GPT-compute-conservation-v1.1.0-082126.md`;
- classifies v1.1.0 as a superseded / historical candidate without moving or deleting it;
- adds a `CONDITIONAL` routing trigger for ChatGPT execution of already-developed plans;
- adds one route example for established-plan execution;
- preserves all unrelated v1.1.11 inventory, routing, cleanup, and unresolved-state records unchanged;
- performs no repository, Git, or GitHub mutation.

Ratification state: not yet ratified. `Artifact-Index-v1.1.11.md` remains the ratified active index until the User explicitly ratifies this successor.

Prior state: v1.1.11 was explicitly User-ratified on 2026-09-17 and superseded v1.0.10.


---

*Document ID: Artifact-Index-v1.1.12 — CANDIDATE / UPDATED — bounded successor adding GPT Compute Conservation v1.2.0 reconciliation.*
