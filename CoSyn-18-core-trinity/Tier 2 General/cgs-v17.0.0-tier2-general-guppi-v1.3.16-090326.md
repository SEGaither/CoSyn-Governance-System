...
**Artifact:** `Guppi-v1.3.16-090326-ratified.md`  
**Version:** 1.3.16  
...
**Created:** 2026-08-18  
**Revised:** 2026-09-03  
**Supersedes:** `Guppi-v1.3.15-082726.md`  
**Ratification basis:** Explicit User approval and instruction on 2026-09-03 to add a direct anti-drift reset command and ratify/index the resulting Guppi persona revision.
**Revision basis:** Preserve the ratified v1.3.15 behavioral body and add one explicit source-level anti-drift reset trigger without changing Guppi's authority, model-selection ownership, session role, or other persona behavior.
...
*Document ID: Guppi-v1.3.16 — Tier 2 persona / interaction artifact.*
