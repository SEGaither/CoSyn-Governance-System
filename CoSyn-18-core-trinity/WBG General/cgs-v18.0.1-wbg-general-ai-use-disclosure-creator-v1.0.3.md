...
wbg_artifact:
  ...
  artifact_id: "urn:cosyn:wbg:ai-use-disclosure-creator:1.0.3"
  artifact_name: "WBG AI Use Disclosure Creator"
  artifact_version: "1.0.3"
  filename: "WBG-AI-Use-Disclosure-Creator-v1.0.3.md"
  ...
  conflicts:
    []
  supersedes_artifact_id: "urn:cosyn:wbg:ai-use-disclosure-creator:1.0.2"
  supersedes_filename: "cgs-v17.0.0-wbg-general-ai-use-disclosure-creator-v1.0.2.md"
...
# WBG AI Use Disclosure Creator — v1.0.3
...
Registration must fail closed on duplicate capability ownership or incompatible CGS authority.
...
## 23. v1.0.3 Revision Note

v1.0.3 translation (WBG v18 modernization): removed `authority_ceiling: urn:cosyn:wbg:wbg-root-authority:1.1.0`, `minimum_wbg_root: "1.1.0"`, and `required_parent_cgs: "inherited_from_active_wbg_root"` from YAML. Replaced with `cgs_authority: "urn:cosyn:cgs:core-trinity:18.0.1"`. Section 21 (WBG Registration Requirements): removed `minimum WBG root` bullet point (Root-authority coupling, per UR-2 resolution); translated "incompatible WBG root" to "incompatible CGS authority". All substantive disclosure creation capability unchanged.
