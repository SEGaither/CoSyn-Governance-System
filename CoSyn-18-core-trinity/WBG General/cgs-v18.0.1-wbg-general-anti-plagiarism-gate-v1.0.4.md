...
wbg_artifact:
  ...
  artifact_id: "urn:cosyn:wbg:anti-plagiarism-gate:1.0.4"
  artifact_name: "WBG Anti-Plagiarism Gate"
  artifact_version: "1.0.4"
  filename: "WBG-Anti-Plagiarism-Gate-v1.0.4.md"
  ...
  conflicts:
    []
  supersedes_artifact_id: "urn:cosyn:wbg:anti-plagiarism-gate:1.0.3"
  supersedes_filename: "cgs-v17.0.0-wbg-general-anti-plagiarism-gate-v1.0.3.md"
...
# WBG Anti-Plagiarism Gate — v1.0.4
...
Registration must fail closed on incompatible CGS authority, missing companion, duplicate capability ownership, or conflict with higher authority.
