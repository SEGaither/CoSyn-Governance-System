...
**Artifact:** `Artifact-Index-v1.2.19-092126-ratified.md`  
**Version:** 1.2.19  
...
**Scope:** Current known CoSyn v18 / Tier artifact set established by ratified v1.1.18, with corrected canonical SHA-256 metadata and repository-state metadata for the Artifact Index. The unrelated local v1.1.16 index candidate remains unratified and is not promoted or incorporated by this revision.  
...
| `Artifact-Index-v1.2.19-092126-ratified.md` | LOCAL RENDERED ARTIFACT — repository installation not performed | 1.2.19 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Artifact-Index-v1.1.18-092126-ratified.md` | Unknown | Not self-recorded; establish externally after final byte generation | Canonical artifact index, cleanup basis, task-routing reference, and project-cache policy reference | Corrected canonical SHA-256 metadata and repository-state metadata from v1.1.18 by explicit User instruction on 2026-09-21; GitHub repository not modified by this revision | KEEP ACTIVE LOCALLY; repository install only by separate authorization |
...
| `Artifact-Index-v1.1.18-092126-ratified.md` | repository root | 1.1.18 | SUPERSEDED / HISTORICAL CANDIDATE | `Artifact-Index-v1.2.19-092126-ratified.md` | Repository presence verified on 2026-09-21; explicit User instruction to correct and index v1.2.19 establishes successor lineage | PRESERVE; repository handling only by separate authorization |
...
| `Artifact-Index-v1.2.19-092126-ratified.md` | `BOUND-BASELINE` | `PROJECT-CACHE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
...
## 18. v1.2.19 Ratified Correction Note

`Artifact-Index-v1.2.19-092126-ratified.md` is the User-ratified successor to `Artifact-Index-v1.1.18-092126-ratified.md`.

This correction changes only the affected index metadata:

- corrects the SHA-256 for `cgs-core-v18.0.1-constitution.md` to `1624F7CDDFBCC23AB999EA5285E507D1CB7B86DBA12D825ECA58E26F55D5EF14`;
- corrects the SHA-256 for `cgs-core-v18.0.2-persona-governor.md` to `22FF2B087EDB3A16D8BD6EFAECFC08F1D955DBA876586DA60F119115D979FD7D`;
- confirms the SHA-256 for `cgs-core-v18.0.2-stack-architect.md` as `BE49AD49185ECED19D974B0494DAFE68BAB391E4D86AADB5E2710F9C8EA04B1A`;
- corrects the SHA-256 for `Guppi-v1.3.17-091726-ratified.md` to `1D12B270131906DD70807E47F4B352B6321938675B61B4058CC609CFD478BB79`;
- records `Artifact-Index-v1.1.18-092126-ratified.md` as present at repository root and superseded by v1.2.19;
- does not alter unrelated routing, cache policy, authority, ATTAS state, or governance content;
- does not modify the GitHub repository.

Ratification basis: explicit User instruction on 2026-09-21 to make the correction and index it as v1.2.19.

---

*Document ID: Artifact-Index-v1.2.19-092126-ratified — RATIFIED / ACTIVE / CURRENT.*
