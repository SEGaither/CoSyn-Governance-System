...
**Artifact:** `Artifact-Index-v1.1.13-091726-ratified.md`  
**Version:** 1.1.13  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-17  
**Supersedes:** `Artifact-Index-v1.1.12.md`  
**Scope:** Current known CoSyn v18 / Tier artifact set established by v1.1.12 plus ratified Zero v3.0.1 and its routing/supersession state.  
...
| `Zero-v3.0.1-091726-ratified.md` | `CONDITIONAL` | Software engineering; LLM/API/agent engineering; scripts; debugging; repository work; Git-adjacent technical execution | Do not load for unrelated writing, general discussion, or nontechnical tasks |
...
| `Artifact-Index-v1.1.13-091726-ratified.md` | `BOUND-BASELINE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
...
## 14. v1.1.13 Ratified Revision Note

`Artifact-Index-v1.1.13-091726-ratified.md` is the User-ratified successor to `Artifact-Index-v1.1.12.md`.

This revision preserves the v1.1.12 GPT Compute Conservation reconciliation and updates only the surfaces invalidated by ratification of Zero v3.0.1.

Changes in v1.1.13:

- replaces Zero v3.0.0 with `Zero-v3.0.1-091726-ratified.md` as RATIFIED / ACTIVE / CURRENT;
- records explicit supersession of `Zero-v3.0.0-090826-ratified.md`;
- routes software, repository, script, debugging, and Git-adjacent technical work to Zero v3.0.1;
- preserves the approved Direct-Path-First Execution amendment in the indexed Zero authority description;
- records this index as RATIFIED / ACTIVE / CURRENT;
- supersedes `Artifact-Index-v1.1.12.md`;
...
Ratification basis: explicit User instruction on 2026-09-17 to update the index for ratified Zero v3.0.1, ratify the updated index, and assign the indexed filename.

---

*Document ID: Artifact-Index-v1.1.13-091726-ratified — RATIFIED / ACTIVE / CURRENT.*
