...
**Artifact:** `Artifact-Index-v1.1.15-091826-ratified.md`  
**Version:** 1.1.15  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-18  
**Supersedes:** `Artifact-Index-v1.1.14-091726-ratified.md`  
**Scope:** Current known CoSyn v18 / Tier artifact set established by v1.1.14 plus ratified ATTAS canon v1.1.2 and its task-routing state.  
...
| `attas-canon-v1.1.2.md` | `CoSyn-18-core-trinity	ier 3ttasttas-canon-v1.1.2.md` | 1.1.2 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `attas-canon-v1.1.1.md` | Unknown | `BF58A09C4D6F932D9E613918FF95BC5694DEF5A8A9063684D14CB294B7F32790` | Authoritative ATTAS Book 1 and continuing-series story canon; canon protections, unresolved canon, approved Veyra/Ligos state, and Ziggy genderless-machine rule | Rendered and ratified by explicit Author instruction on 2026-09-18; SHA-256 independently established from rendered artifact | KEEP ACTIVE |
| `Artifact-Index-v1.1.15-091826-ratified.md` | repository root when installed | 1.1.15 | RATIFIED / ACTIVE / CURRENT | Unknown | Unknown | `Artifact-Index-v1.1.14-091726-ratified.md` | Unknown | self-hash assigned after final byte generation | Canonical artifact index, cleanup basis, and task-routing reference | Updated and ratified by explicit User instruction on 2026-09-18 to index `attas-canon-v1.1.2.md` | KEEP ACTIVE |
...
| `attas-canon-v1.1.2.md` | `CONDITIONAL` | ATTAS story-canon, manuscript-development, continuity, character/worldbuilding, canon-protection, or canon-reconciliation work | Do not load for unrelated writing projects or non-ATTAS tasks |
| `Artifact-Index-v1.1.15-091826-ratified.md` | `BOUND-BASELINE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
