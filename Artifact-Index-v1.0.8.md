...
**Artifact:** `Artifact-Index-v1.0.8.md`  
**Version:** 1.0.8  
**Status:** DRAFT / PARTIAL — SOURCE-BOUNDED  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-08  
**Supersedes:** `Artifact-Index-v1.0.7.md`  
...
|---|---|---:|---|---|---|---|---|---|---|---|
| `Guppi-v1.3.16-090326-ratified.md` | Unknown in repository | 1.3.16 | RATIFIED / ACTIVE — WORKING CANONICAL | Unknown | `work-session-management-team-persona-v1.1.0-082626.md` | `Guppi-v1.3.15-082726.md` | Unknown | `2af48ab7f4a6a6b2fb45f952646597ee98e81b07080cbdfab3800f4f65072736` | Cross-project assistant identity, interaction character, response behavior | Canonical artifact/hash/supersession established; repository path and full dependency graph unresolved |
| `cgs-v18.0.1-tier2-personal-response-instructions-v1.2.md` | `tier 2\t2-cgs-psnl\` | 1.2 | RATIFIED / ACTIVE | Unknown | Unknown | `cgs-v17.0.0-tier2-personal-response-instructions-v1.1.md` | Unknown | `B1BB65437CB02A3E1D89519E757FD19B4B4C63804FD958F329DA84091D908969` | Cross-project response compactness, usable-path behavior, and root-cause closure | Repository deployment runtime-evidenced and byte-identical to the approved artifact |
...
| `work-session-management-team-persona-v1.1.0-082626.md` | Unknown in repository | 1.1.0 | RATIFIED / ACTIVE | `Guppi-v1.3.16-090326-ratified.md`; `git-repository-change-safety-protocol-v1.0.0-082126.md` | Unknown | `work-session-management-team-persona-v1.0.0-082126.md` | Unknown | Unknown | Cross-project work-session management and specialist routing | Canonical source established; exact repository path/hash and other explicit dependencies unresolved |
| `git-repository-change-safety-protocol-v1.0.0-082126.md` | Unknown in repository | 1.0.0 | RATIFIED / ACTIVE | Unknown | `work-session-management-team-persona-v1.1.0-082626.md` | Unknown | Unknown | Unknown | Git repository inspection/change safety | Canonical source established; repository path/hash unresolved |
| `cgs-core-v18.0.1-constitution.md` | Unknown in repository | 18.0.1 | COMPLETE / RATIFIED | Unknown | `cgs-core-v18.0.1-persona-governor.md`; `cgs-core-v18.0.1-stack-architect.md` | Unknown | Unknown | `1624F7CDDFBCC23AB999EA5285E507D1CB7B86DBA12D825ECA58E26F55D5EF14` | Core constitutional governance | Presence/hash established by continuity package; exact path and source-level dependency graph incomplete |
| `cgs-core-v18.0.1-persona-governor.md` | Unknown in repository | 18.0.1 | COMPLETE / RATIFIED | `cgs-core-v18.0.1-constitution.md` | `cgs-core-v18.0.1-stack-architect.md` | Unknown | Unknown | `C9067910C46F5FAAD7C9A4FADEEC2C14A4AAE8998F94E54B469887116C21559B` | Persona governance | Presence/hash and direct Constitution dependency established; exact path and any additional source dependencies unresolved |
| `cgs-core-v18.0.1-stack-architect.md` | Unknown in repository | 18.0.1 | COMPLETE / RATIFIED | `cgs-core-v18.0.1-constitution.md`; `cgs-core-v18.0.1-persona-governor.md` | Unknown | Unknown | Unknown | `C1C8C301D8ABC6F7350E07A61EE3DD4523FC0AE056E3CDFB59CADF98B31CDCC1` | Stack / authority architecture | Presence/hash and direct Core dependencies established; exact path and any additional source dependencies unresolved |
...
*Document ID: Artifact-Index-v1.0.8 — partial canonical artifact index.*
