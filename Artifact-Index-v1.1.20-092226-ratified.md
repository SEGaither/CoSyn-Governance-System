...
**Artifact:** `Artifact-Index-v1.1.20-092226-ratified.md`  
**Version:** 1.1.20  
...
**Created:** 2026-09-03  
**Revised:** 2026-09-22  
**Supersedes:** `Artifact-Index-v1.1.19-092126-ratified.md`  
**Scope:** Current known CoSyn v18 / Tier artifact set established by ratified v1.1.19, plus the ratified end-session provenance-lineage workflow update. The unrelated local v1.1.16 index candidate remains unratified and is not promoted or incorporated by this revision.  
...
| `Artifact-Index-v1.1.20-092226-ratified.md` | `BOUND-BASELINE` | `PROJECT-CACHE` | First routing reference for determining which artifacts apply | The index routes; it does not replace the instructions in selected artifacts |
